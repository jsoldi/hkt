...
// import { ITransform, ITransformer, KTransform } from "./transform.js";
...
// export interface ILeft<R = unknown> extends ITransformer<KLeft<R>> {
...
//                 outer.bind(fa, either.either(f, r => outer.unit(either.right(r))))
//         });
